...
namespace NodeCanvas.Framework {
    ...
    partial class Node {
        ...
        virtual public Color successColor { get { return new Color(0.4f, 0.7f, 0.2f); } }
        ...
        */
        ...
        void HandleNodePosition(Event e) {
            ...
            if (Graph.allowClick && e.button != 2) {
                ...
                //snap to grid
                if (!hierarchicalMove && NCPrefs.doSnap && Graph.multiSelection.Count == 0/* !Graph.multiSelection.Contains(this)*/) {
                    //nodePosition = new Vector2(Mathf.Round(nodeRect.center.x / 15) * 15, Mathf.Round(nodeRect.center.y / 15) * 15) - nodeRect.size / 2;
                    nodePosition = new Vector2(Mathf.Round(nodeRect.position.x / 15) * 15, Mathf.Round(nodeRect.position.y / 15) * 15);
                }
